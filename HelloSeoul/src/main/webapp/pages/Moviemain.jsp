...
<!-- 									<p class='m2-kvs-detail'>2023.03.25 ~ 2023.06.18 부산 드림씨어터</p> -->
						...
						<div class='swiper-slide'>
							<a
								href='GenreBridge.aspx.html?genre=15457&id=1099&Gcode=009_400&Gcode=009_400'
...
<section class='m2-sec02'>  <!-- WHAT'S HOT 시작 -->
		...
		<div class='ms-list-imgs'>   <!-- 첫줄 5개의 컨텐츠 DIV 5개씩 묶고 끊기 -->
			<a href='/Perf/44163?Gcode=009_403' target='_self' title='더 퍼스트 슬램덩크'><div
...
<!-- 						<p class='list-b-circle'>30%</p> -->
				...
				</div></a><a href='/Perf/44525?Gcode=009_403' target='_self' title='대외비'><div
					class='list-bigger-wrap'>
					<img class='lazyload'
...
<!-- 						<p class='list-b-circle'>25%</p> -->
		...
		<div class='ms-list-imgs'>  <!-- 둘째줄 5개의 컨텐츠 DIV 5개씩 묶고 끊기 -->
			<a href='/Perf/44090?Gcode=009_403' target='_self' title='카운트'><div
			 class='list-bigger-wrap'>
					<img class='lazyload'
...
<!-- 						<p class='list-b-circle'>30%</p> -->
				...
				</div></a><a href='/Perf/44576?Gcode=009_403' target='_self' title='귀멸의 칼날-상현집결, 그리고 도공 마을로'><div
					class='list-bigger-wrap'>
					<img class='lazyload'
...
<!-- 						<p class='list-b-circle'>20%</p> -->
			...
			</a><a href='/Perf/44745?Gcode=009_403' target='_self' title='아바타-물의 길'><div
					class='list-bigger-wrap'>
					<img class='lazyload'
