	...
	<div class="board-field">
		...
		<div class="col-md-8">
			<div class="board-toolbar" 	style="text-align: right; margin-bottom: 20px">
				...
				<a href="/web/board/write.jsp?id=${id}" class="btn btn-primary btn-sm"><i
					class="glyphicon glyphicon-pencil" style="margin-right: 15px"></i>쓰기</a>
			</div>
			<div class="list-group">

				<c:forEach var="i" items="${list}" varStatus="cnt">
				<a href="/web/hitProccess?no=${i.no}&job=info&page=1&id=${i.id}" class="list-group-item">
					...
					<div class="board-meta"
						...
						<p>
							<i class="glyphicon glyphicon-user"></i> ${i.writer} <i
