		...
		<div class="list-group">
			...
			<div class="list-group-item">
				...
				<p style="text-align: center; margin-top: 30px">
					<button class="btn btn-success" id="good" name="good">
						<i class="glyphicon glyphicon-thumbs-up"></i>공감
					</button>
					<button class="btn btn-warning" id="bad" name="bad">
			...
			<div class="bottom" style="margin: 10px;margin-top: 20px; text-align: right">
				...
				<a href="deleteAction?no=${info.no}" id="delete" name="delete" target="_action_frame_bbs" class="btn btn-default btn-xs" onclick="return confirm('정말로 삭제하시겠습니까?');">삭제</a> 
